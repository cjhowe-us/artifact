"""gh-gist storage — `gist` artifacts via `gh` CLI.
...
def cmd_create(*, scheme, adapter, input, uri):
    raise NotImplementedError("gh-gist create not implemented in this skeleton")
...
def cmd_delete(*, scheme, adapter, input, uri):
    raise NotImplementedError("gh-gist delete not implemented in this skeleton")
