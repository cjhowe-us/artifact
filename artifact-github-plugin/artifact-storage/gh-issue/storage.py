"""gh-issue storage — `issue` artifacts via `gh` CLI.
...
def cmd_create(*, scheme, adapter, input, uri):
    raise NotImplementedError("gh-issue create not implemented in this skeleton")
...
def cmd_delete(*, scheme, adapter, input, uri):
    raise NotImplementedError("gh-issue delete not implemented in this skeleton")
