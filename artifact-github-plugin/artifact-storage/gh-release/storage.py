"""gh-release storage — `release` artifacts via `gh` CLI.
...
def cmd_create(*, scheme, adapter, input, uri):
    raise NotImplementedError("gh-release create not implemented in this skeleton")
...
def cmd_delete(*, scheme, adapter, input, uri):
    raise NotImplementedError("gh-release delete not implemented in this skeleton")
