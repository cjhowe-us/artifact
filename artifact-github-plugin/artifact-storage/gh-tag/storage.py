"""gh-tag storage — `tag` artifacts via `gh` CLI.
...
def cmd_create(*, scheme, adapter, input, uri):
    raise NotImplementedError("gh-tag create not implemented in this skeleton")
...
def cmd_delete(*, scheme, adapter, input, uri):
    raise NotImplementedError("gh-tag delete not implemented in this skeleton")
