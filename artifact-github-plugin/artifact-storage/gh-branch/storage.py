"""gh-branch storage — `branch` artifacts via `gh` CLI.
...
def cmd_create(*, scheme, adapter, input, uri):
    raise NotImplementedError("gh-branch create not implemented in this skeleton")
...
def cmd_delete(*, scheme, adapter, input, uri):
    raise NotImplementedError("gh-branch delete not implemented in this skeleton")
